...
<html lang="en">
  ...
  <body>
	...
	<div class="container home-container my-4 d-flex flex-column align-items-center justify-content-center" style="height:80vh; background:linear-gradient(to top right, pink, skyblue);" >
